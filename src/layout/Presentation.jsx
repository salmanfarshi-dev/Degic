...
function Presentation() {
  return (
   <section className="bg-gray-50 md:py-[135px] py-10">
    <div className="md:px-20 px-4 container mx-auto flex flex-col md:flex-row items-start gap-x-20 ">
        ...
        <Subheading text="The quickest way to create modern presentation" className="md:w-[440px] md:leading-[60px]" />
        <Pera text="Best software platform for running an internet business. We build the most powerful and flexible tools for internet commerce." className="md:w-[440px] mt-4 mb-8"/>
          <Button variant="contained" endIcon={<EastIcon />} className="!bg-[#5F62E2] !bg-opacity-[15%] !text-[#5F62E2] !capitalize">
        Explore All
      </Button>
