          ...
          <div className="">
            ...
            <div className=" mt-6 flex flex-col py-2">
              <div className="flex items-center gap-x-3">
                ...
                <p className="text-black text-[16px] md:text-xl font-normal font-inter tracking-[-0.8px ] ">
              ...
              <Button
                variant="contained"
                endIcon={<EastIcon />}
                className="!bg-[#5F62E2] !bg-opacity-[15%] !text-[#5F62E2] !capitalize !text-[16px] !w-fit !mt-6 "
              >
               Learn more
              </Button>
            </div>
          ...
          <div className=" mt-4 md:mt-0">
            ...
            <div className=" mt-6 flex flex-col py-2">
              <div className="flex items-center gap-x-3">
                ...
                <p className="text-black md:text-xl font-normal font-inter tracking-[-0.8px ]">
                  Many ways to use illustrations in design
                </p>
              </div>
              <div className="flex items-center gap-x-3">
